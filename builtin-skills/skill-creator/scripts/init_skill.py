...
If --path is not specified, defaults to ~/.claude/skills/
...
def get_default_skills_path():
    """Return the default skills directory: ~/.claude/skills/"""
...
def main():
    ...
    # Parse optional --path argument, default to ~/.claude/skills/
